<template>
  <header>
    ...
    <p>
      I’m a software engineer specializing in front-end with an objective of lead. I have about 6+ years professional experience with common <b>front-end technologies</b> such as: <b class="text-primary">JavaScript/ES6</b>, <b class="text-primary">HTML/CSS</b>, <b class="text-primary">Vue</b>, <b class="text-primary">Node</b>.
    ...
    <p>
      I've also gained experience of <b>development and deployment pipeline</b> usings tools such as: <b class="text-primary">Git</b>, <b class="text-primary">Vim/Bash</b>, <b class="text-primary">Gitlab</b> for code management and reviews. <b class="text-primary">Rancher/Nerdctrl or Docker CLI</b>, <b class="text-primary">Jenkins</b> to push code/features to dev and production. 
    </p>
    <p>
